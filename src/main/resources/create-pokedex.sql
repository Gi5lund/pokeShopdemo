...
create Table pokedex.pokemon (pokedex_number smallint unsigned primary key,
                      `name` varchar(50) not null,
                      speed smallint unsigned,
                      special_defence smallint unsigned,
                      special_attack smallint unsigned,
                      defence smallint unsigned,
